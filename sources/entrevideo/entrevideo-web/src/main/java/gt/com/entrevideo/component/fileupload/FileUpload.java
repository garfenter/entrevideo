...
@FacesComponent(value = "UIFileUpload") 
public class FileUpload extends UIInput implements org.primefaces.component.api.Widget {

    public static final String COMPONENT_TYPE = "UIFileUpload";
    public static final String COMPONENT_FAMILY = "gt.com.papiro.component";
    private static final String DEFAULT_RENDERER = "UIFileUploadRenderer";
    private static final String OPTIMIZED_PACKAGE = "gt.com.papiro.component.fileupload.";

    protected enum PropertyKeys {

        widgetVar, update, process, fileUploadListener, multiple, auto, label, allowTypes, sizeLimit, showButtons, style, styleClass, mode, uploadLabel, cancelLabel, invalidSizeMessage, invalidFileMessage, dragDropSupport, onstart, oncomplete, disabled;
        String toString;
