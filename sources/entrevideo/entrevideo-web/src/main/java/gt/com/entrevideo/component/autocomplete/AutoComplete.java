...
public class AutoComplete extends HtmlInputText implements org.primefaces.component.api.Widget, org.primefaces.component.api.InputHolder {
    ...
    public static final String COMPONENT_TYPE = "gt.com.entrevideo.component.AutoComplete";
    public static final String COMPONENT_FAMILY = "gt.com.entrevideo.component";
    private static final String DEFAULT_RENDERER = "gt.com.entrevideo.component.AutoCompleteRenderer";
    private static final String OPTIMIZED_PACKAGE = "gt.com.entrevideo.component.";

    protected enum PropertyKeys {

        widgetVar, completeMethod, var, itemLabel, itemValue, maxResults, minQueryLength, queryDelay, forceSelection, onstart, oncomplete, global, scrollHeight, effect, effectDuration, dropdown, panelStyle, panelStyleClass, multiple, process, itemtipMyPosition, itemtipAtPosition;
        String toString;
    ...
    public AutoComplete() {
        logger.log(Level.INFO, "Inicializando componente autocomplete");
    ...
    public void queueEvent(FacesEvent event) {
        logger.log(Level.INFO, "Agregando evento");
    ...
    public List getSuggestions(String query) {
        ...
        if (me != null) {
            suggestions = (List) me.invoke(facesContext.getELContext(), new Object[]{query});
